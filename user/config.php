...
define( 'YOURLS_DB_USER', 'matheuscfernandes' );

/** MySQL database password */
define( 'YOURLS_DB_PASS', '901224' );

/** The name of the database for YOURLS */
define( 'YOURLS_DB_NAME', 'l.fer.me' );
...
define( 'YOURLS_SITE', 'http://l.fer.me' );
